...
public class T01_FileTest {
	public static void main(String[] args) throws IOException {
		 ...
		 *  => 디렉토리와 디렉토리 사이 또는 디렉토이와 파일명 사이의 구분문자는 '\'를 사용하거나 '/'를 사용할 수 있다.
		 */
...
//		File file2 = new File("d:/D_Other/test.txt");
		...
		//  => 'parent'디렉토리 안에 있는 'chile'파일 또는 디렉도리를 말한다.
		...
		System.out.println("표준 경로 : " + file4.getCanonicalPath()); // 예외가 발생한다
